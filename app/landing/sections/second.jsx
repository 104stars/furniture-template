    ...
    <section className="container mx-auto py-16 px-4 sm:px-6 lg:px-8 bg-zinc-100">
      <div className="flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-20">
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <Button className="font-normal font-inter">Explore store</Button>
        </div>
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <p className="text-lg sm:text-xl text-gray-600 font-inter">
            ...
            chosen with both aesthetics and sustainability in mind, ensuring
            your home remains beautiful for generations to come.
          </p>
          <Button variant="outline" className="font-normal font-inter">
            Learn More
          </Button>
        </div>
      </div>
